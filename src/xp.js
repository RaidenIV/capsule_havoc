...
import { XP_THRESHOLDS, ENEMY_HP, WEAPON_CONFIG } from './constants.js';
...
export function getXPPerKill()  { return 10; }
export function getCoinValue()  { return 1; }
export function getEnemyHP()    { return ENEMY_HP; }
export function getWeaponConfig() { return WEAPON_CONFIG[Math.min(state.weaponTier, WEAPON_CONFIG.length - 1)]; }

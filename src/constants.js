...
// ── Wave system (10 waves, boss pack after each wave) ───────────────────────
export const STANDARD_ENEMY_SIZE_MULT = 0.75; // standard enemies are 25% smaller than player
...
// Weapon-tier upgrades are purchased with coins (higher tiers cost more).
// Index corresponds to WEAPON_CONFIG tier.
export const UPGRADE_COST_BY_TIER = [0, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024];
